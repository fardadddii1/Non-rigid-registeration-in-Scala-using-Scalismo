...
object landmarks extends App {

  scalismo.initialize()
  implicit val rng = scalismo.utils.Random(42)

  val ui = ScalismoUI()
  val paolaGroup = ui.createGroup("head_01")

  val mesh: TriangleMesh[_3D] = MeshIO.readMesh(new java.io.File("files/head_01.stl")).get
  val meshView = ui.show(paolaGroup, mesh, "head_01")
  ...
  val ptIds = Seq(PointId(2213), PointId(4727), PointId(8320), PointId(182))
